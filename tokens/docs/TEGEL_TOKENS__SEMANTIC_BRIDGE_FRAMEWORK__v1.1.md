...
**VERSION: 1.1 [LOCKED/Minor Update: Property-First Ordering]**
...
This framework is considered **LOCKED v1.1**.  
Changes must be deliberate and systemic.

v1.1 update:
- Token naming order changed to property-first grouping.
- No semantic or structural rules altered.
...
## 10. Mandatory Header Template (Property-First Pattern)
...
Framework status: LOCKED v1.1

This version introduces property-first ordering for improved grouping and tool alignment.  
All semantic rules remain unchanged.
